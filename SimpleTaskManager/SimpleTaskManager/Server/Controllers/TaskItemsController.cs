...
namespace SimpleTaskManager.Server.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class TaskItemsController : ControllerBase
    {
        private readonly SimpleTaskManagerServerContext _context;

        public TaskItemsController(SimpleTaskManagerServerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TaskItem>> PostTaskItem(TaskItem taskItem)
        {
          if (_context.TaskItem == null)
          {
              return Problem("Entity set 'SimpleTaskManagerServerContext.TaskItem'  is null.");
          }
